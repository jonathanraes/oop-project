 ...
 * Een logical_test, een value_if_true en een value_if_false. In die volgorde moeten deze parameters ook meegegeven worden aan de formule
 * IF(a,b,c). De logical_test wordt bekeken of hij waar of niet waar is. Als hij waar is, dan returnt het de value_if_true (b) en is de
 * logische test niet waar, dan returnt hij de value_if_false (c). Value_if_true en value_if_false kunnen een String, integer of double zijn.
 * 
**/
public class IF extends Formule {
	/**
	 * IF(logical_test , value_if_true , value_if_false) wordt hier verwerkt.
	 * @param String[] waardes: De String array met de waardes van de geselecteerde cel(len), de value_if_true en de value_if_false.
	 * @return String de value_if_true of de value_if_false afhankelijk van of de logical_test waar of onwaar is.
	 */
