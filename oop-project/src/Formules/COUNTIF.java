...
/**
 * COUNTIF klasse. Hierin wordt de formule COUNTIF uitgevoerd. COUNTIF telt het
 * aantal cellen in de geselecteerde reeks aan cellen die voldoen aan een
 * opgegeven criteria door de gebruiker. Dit wordt gedaan in de vorm van een
 * expressie. Bijv: "=32", ">32", "apples", etc.
 * 
 **/
public class COUNTIF extends Formule {
	 ...
	 * 
	 * @param String
	 *            [] waardes: De String array met de waardes van de
	 *            geselecteerde cellen.
	 * @return String met het aantal cellen die voldoen aan de gespecificeerde
	 *         criteria.
	 */
