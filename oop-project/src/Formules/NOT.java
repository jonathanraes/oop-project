...
/**
 * Bij deze klasse wordt de formule NOT uitgevoerd. 
 * NOT wordt gebruikt om de tegenovergestelde te krijgen van de geldigheid van een statement.
 * Bijvoorbeeld: NOT(1>3) ---> true
 *   
**/
public class NOT extends Formule {
	/**
	 * NOT(logical_test) . 
	 * Hierbij wordt naar de logical_test gekeken en als het waar is wordt er "false" geretourneerd en als het onwaar is, wordt er "true" geretourneerd.
	 * @param String[] waardes: De String array met de logical test
	 * @return true of false, afhankelijk van het uitkomst van de logical test.
	 */
